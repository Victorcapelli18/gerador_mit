...
class ResponsavelApuracao(BaseModel):
    ...
    cpf: str = Field(..., alias="CpfResponsavel")
    tel_responsavel: Optional[TelefoneResponsavel] = Field(None, alias="TelResponsavel")
    email_responsavel: Optional[str] = Field(None, alias="EmailResponsavel")
    registro_crc: Optional[RegistroCrc] = Field(None, alias="RegistroCrc")